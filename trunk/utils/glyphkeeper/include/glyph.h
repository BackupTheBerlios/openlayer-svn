...
#define GK_VERSION_MINOR  29
#define GK_VERSION_PATCH  1
#define GK_VERSION_STR    "0.29.1"
#define GK_DATE_STR       "2005-07-09"
...
GLYPH_DECLSPEC GLYPH_FACE* _gk_load_face_from_file
    ( const char* const fname, const int face_index,
      const int header_version, const int gk_header_target );
